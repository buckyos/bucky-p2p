...
use crate::modify::{modify_desc, modify_subcommand};
use crate::show::{show_desc, show_desc_subcommand};
use crate::sign::{sign_desc, sign_subcommand};
...
async fn main_run() {
    simple_logger::SimpleLogger::new()
        ...
        .init()
        .unwrap();
    let matches = App::new("desc-tool")
        .about("tool to create or show desc files")
