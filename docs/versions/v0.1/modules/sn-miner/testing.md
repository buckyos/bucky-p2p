...
|-----------|---------------|----------------|------------------|----------|-----|-------------------|
| sn_miner_startup_audit | V-1 | unit | sn-miner-unit | 验证本地启动逻辑仍可执行 | no | |
| sn_miner_startup_audit | V-2 | dv | sn-miner-dv | 验证操作入口仍可执行 | no | |
| sn_miner_artifact_defaults | V-3 | integration | sn-miner-integration | 验证与适配层和工作区契约兼容 | no | |
