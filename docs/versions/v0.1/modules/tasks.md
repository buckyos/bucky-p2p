...
|---------|--------|-------------|--------|-------|---------------|------------|-------|
| 001-control-stream-runtime-fixes | p2p-frame | docs/versions/v0.1/modules/p2p-frame/001-control-stream-runtime-fixes/ | draft | user | proposal | control_stream_callback_dispatch, control_stream_per_stream_overflow, control_stream_id_validation, control_stream_ordered_shutdown, control_stream_terminal_delivery, control_stream_tunnel_close_writes, control_stream_read_buffer_performance | Sibling fix for approved tunnel_control_stream_api; unrelated to the selected reverse data first-claim repair. |
