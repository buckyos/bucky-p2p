...
| runtime/integration | yes | multi-service owner/serving/listener flows, SnServer TTP client | Key Call Flows, Implementation Order | targeted unit plus DV/integration gap recording if no harness | owner: testing; risk: partial failure |
